...
echo deleting README_MD.base16 README.MD.gz.BfF.ascii85 README.MD.Whirlpool.bz.Hex32 README.MD.SCrypt.zip.uu README.MD.BCrypt.zip.xx READ_MD.txt READ_GUNZIP.txt READ_UNZIP.txt READ_BUNZIP.txt README_SYM_BCRYPT_UNZIP.txt

del /q README_MD.base16 README.MD.gz.BfF.ascii85 README.MD.Whirlpool.bz.Hex32 README.MD.SCrypt.zip.uu README.MD.BCrypt.zip.xx READ_MD.txt READ_GUNZIP.txt READ_UNZIP.txt READ_BUNZIP.txt README_SYM_BCRYPT_UNZIP.txt
@echo on
...
EU.CqrXs.Console.exe -V -D -M=CFB -i=.\README.MD.Whirlpool.bz.Hex32 -e=hex32 -k=heinrich.elsigan@heinrichelsigan.area23.at -H=Whirlpool -z=bz -o=.\READ_BUNZIP.txt 
...
start notepad README_SECURE.txt
