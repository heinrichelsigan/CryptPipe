...
namespace EU.CqrXs.Gui.Forms
{
    ...
    /// <summary>
    /// EncryptFormAsymmetric
    /// </summary>
    public partial class EncryptFormAsymmetric : EncryptFormBase
    {

        protected internal AsymmetricCipherPipe? aCPipe = null;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EncryptFormAsymmetric"/> class.
        /// </summary>
        /// <remarks>This constructor sets up the form and initializes its components.  It should be
        /// called when creating a new instance of the <see cref="EncryptFormAsymmetric"/> form.</remarks>
        public EncryptFormAsymmetric()
        {
            InitializeComponent();
            
                     
            mCipherModes = new ToolStripMenuItem[] { menuCipherAlgoRsa, menuCipherAlgoDsa, menuCipherAlgoDH, menuCipherAlgoGPG };
            ...
            menuMainOneTwoThreeFish.Click += new System.EventHandler(async (sender, e)
                 => await menuMainOneTwoThreeFish_Click(sender, e));
            menuMainSimple.Click += menuMainSimple_Click;
            ...
            this.Load += new System.EventHandler(async (sender, e)
                => await EncryptFormAsymmetric_LoadAsync(sender, e));
        }


        /// <summary>
        /// EncryptFormAsymmetric_LoadAsync - form load event
        /// </summary>
        ...
        protected internal async Task menuCipherMode_Click(object sender, EventArgs e)
        {
            ...
            foreach (var cipherModeItem in mCipherModes)
            {
                ...
                cipherModeItem.CheckState = CheckState.Unchecked;
            }

            if (sender is ToolStripMenuItem mi && mi.Name != null &&
                (mi.Name.StartsWith("menuCipherAlgo") || mi.Name.StartsWith("menuCipher")))
            {
                mi.Checked = true;
                mi.CheckState = CheckState.Checked;
                string cipherModeString = mi.Name.Replace("menuCipherAlgo", "").Replace("menuCipher", "");
                ...
                AsymmetricCipherEnum aCEnum = Enum.TryParse<AsymmetricCipherEnum>(cipherModeString, out AsymmetricCipherEnum asymCipherAlgo) ? asymCipherAlgo : AsymmetricCipherEnum.Rsa;

                if (aCPipe != null)
                {
                    aCPipe.AsymmetricCipherAlgo = aCEnum;
                    aCPipe.CMode2 = cmode2;
                    await groupBoxFiles.pictureBoxRunningPipe.SetImageTagVisibleAsync(aCPipe?.GenerateEncryptPipeImage());
                }
                await SetInfoMessageAsync($"AsymmetricCipherEnum {aCEnum.ToString()} set.", ToolTipIcon.Info, 2000);
            }
        }
        ...
        protected internal async Task comboCipherMode_Changed(object sender, EventArgs e)
        {
            ...
            {
                case "RSA":
                case "Rsa": await menuCipherMode_Click(menuCipherAlgoRsa, e); return;
                case "DSA":
                case "Dsa": await menuCipherMode_Click(menuCipherAlgoDsa, e); return;
                case "DH":  await menuCipherMode_Click(menuCipherAlgoDH, e); return;
                case "Gpg":
                case "gpg":
                case "PGP":
                case "Pgp":
                case "pgp":
                case "GPG": await menuCipherMode_Click(menuCipherAlgoGPG, e); return;
            ...
            switch (comboBoxCipherModes.Items[comboBoxCipherModes.SelectedIndex])
            {
                ...
                case "RSA":
                case "Rsa": 
                default: await menuCipherMode_Click(menuCipherAlgoRsa, e); break;
            }
        }



        public AsymmetricCipherEnum GetAsymmetricCipherEnum()
        {
            foreach (var cipherModeItem in mCipherModes)
            {
                if (cipherModeItem.Checked || cipherModeItem.CheckState == CheckState.Checked)
                {
                    string cipherModeString = cipherModeItem.Text;
                    AsymmetricCipherEnum aCEnum = Enum.TryParse<AsymmetricCipherEnum>(cipherModeString, out AsymmetricCipherEnum asymCipherAlgo) ? asymCipherAlgo : AsymmetricCipherEnum.Rsa;
                    return aCEnum;
                }
            }
            this.menuCipherAlgoRsa.Checked = true;
            this.menuCipherAlgoRsa.CheckState = CheckState.Checked;
            return AsymmetricCipherEnum.Rsa;
        }
        ...
        protected internal void SetCipherMode(CipherMode2 cMode2)
        {
            ...
            {
                aCPipe.CMode2 = cMode2;
                groupBoxFiles.pictureBoxRunningPipe.Image = aCPipe?.GenerateEncryptPipeImage();
            }
        ...
        private void pictureBoxDelete_Click(object sender, EventArgs e)
        {
            ...
            if (aCPipe != null)
            {
                aCPipe.InPipe = Array.Empty<CipherEnum>();

                SetPictureBoxImage(groupBoxFiles.pictureBoxRunningPipe, aCPipe.GenerateEncryptPipeImage(), "", true);
            }
            else
        ...
        protected internal void Hash_Pipe_Click(object sender, EventArgs e)
        {
            ...
            aCPipe = new AsymmetricCipherPipe(textBoxKey.Text, this.textBoxPrivateKey.Text, GetCipherMode2());
            foreach (CipherEnum cipher in aCPipe.InPipe)
            {
                this.textBoxPipe.Text += cipher.ToString() + ";";
            }
            SetPictureBoxImage(groupBoxFiles.pictureBoxRunningPipe, aCPipe.GenerateEncryptPipeImage());
        }
        ...
        protected internal void SetPipeline_Click(object sender, EventArgs e)
        {
            ...
            aCPipe = new AsymmetricCipherPipe(textBoxKey.Text, textBoxPrivateKey.Text, GetCipherMode2());
            foreach (CipherEnum cipher in aCPipe.InPipe)
            {
                this.textBoxPipe.Text += cipher.ToString() + ";";
            }
        ...
        protected internal void RandomText_Click(object sender, EventArgs e)
        {
            ...
            if (fortunes.Length > 0)
            {
                ...
                tabControlWithHexSrc.Text = fortunes[rIdx];
            }
        }
        ...
        protected internal async Task Reset_Click(object sender, EventArgs e)
        {
            ...
            tabControlWithHexSrc.Text = string.Empty;
            // this.tabControlWithHexDest.EncoderType = EncodingType.None;
            tabControlWithHexDest.Text = string.Empty;
            aCPipe = null;
        ...
        protected internal void pictureBoxAddAlgo_Click(object sender, EventArgs e)
        {
            ...
            {
                if (cipherAlgos.Length < Constants.PIPE_MAX_LEN)
                {
                    switch (cipherEnum)
                    {
                    ...
                    aCPipe = new AsymmetricCipherPipe(cipherAlgos, Constants.PIPE_MAX_LEN, GetCipherMode2());
                    SetPictureBoxImage(groupBoxFiles.pictureBoxRunningPipe, aCPipe.GenerateEncryptPipeImage(), "", true);
                ...
                {
                    SetInfoMessage($"Max {Constants.PIPE_MAX_LEN} algorithms in pipe reached!", ToolTipIcon.Warning, 2000);
                }
            }
        }
        ...
        protected internal async Task Encrypt_Click(object sender, EventArgs e)
        {
            ...
            aCPipe = new AsymmetricCipherPipe(pipeAlgos, Constants.PIPE_MAX_LEN, GetCipherMode2());

            await groupBoxFiles.pictureBoxRunningPipe.SetImageTagVisibleAsync(aCPipe.GenerateEncryptPipeImage());

            DateTime start = DateTime.Now;
            string getText = tabControlWithHexSrc.Text;

            if (!string.IsNullOrEmpty(getText))
            {
                tabControlWithHexDest.Text = "";
                // this.tabControlWithHexDest.EncoderType = EncodingType.None;
                ...
                try
                {
                    await this.statusLabelSource.SetTextAsync($"source chars: {getText.Length}");

                    string encrypted = aCPipe.EncrpytTextGoRounds(tabControlWithHexSrc.Text, this.textBoxKey.Text, this.textBoxPrivateKey.Text, GetCipherMode2());
            ...
            if (!string.IsNullOrEmpty(groupBoxFiles.labelFileIn.Text) && !groupBoxFiles.labelFileIn.Text.StartsWith("["))
            {
                ...
                try
                {
                    ...
                    byte[] encodedBytes = aCPipe.EncryptEncodeBytes(fileBytes, this.textBoxKey.Text, this.textBoxPrivateKey.Text, GetCipherMode2());
                    string miniPipe = string.IsNullOrEmpty(aCPipe.PipeString) ? "" : "." + aCPipe.PipeString;
                    ...
                    if (saved)
                    {
                        ...
                        if (sha512ToolStripMenuItem.Checked)
                            isVerified = await VerifyEncryptedFileShaAsync(fileName, outFilePath, textBoxKey.Text, this.textBoxPrivateKey.Text, aCPipe);
                        if (bytesOfFileToolStripMenuItem.Checked)
                            isVerified = await VerifyEncryptedFileBytesAsync(fileName, outFilePath, textBoxKey.Text, this.textBoxPrivateKey.Text, aCPipe);
        ...
        protected internal async Task Decrypt_Click(object sender, EventArgs e)
        {
            ...
            await this.groupBoxFiles.pictureBoxRunningPipe.SetImageTagVisibleAsync(aCPipe.GenerateDecryptPipeImage());
            ...
            if (!string.IsNullOrEmpty(this.tabControlWithHexSrc.Text))
            {
                ...
                try
                {
                    ...
                    string decrypted = aCPipe.DecryptTextRoundsGo(this.tabControlWithHexSrc.Text, textBoxKey.Text, this.textBoxPrivateKey.Text, GetCipherMode2());
            ...
            if (!string.IsNullOrEmpty(groupBoxFiles.labelFileIn.Text) && !groupBoxFiles.labelFileIn.Text.StartsWith("["))
            {
                ...
                {
                    byte[] fileBytes = await System.IO.File.ReadAllBytesAsync(fileName);
                    byte[] outBytes = aCPipe.DecodeDecrpytBytes(fileBytes, this.textBoxKey.Text, this.textBoxPrivateKey.Text, GetCipherMode2());
        ...
        internal void FileAddedAction(string fileName)
        {
            ...
            if (fi.Exists && fi.Length > 0)
            {
                ...
                {
                    aCPipe = GetACPipeFromFileName(fileName);
                    if (aCPipe != null)
                    {                        
                        this.textBoxPipe.Text = "";
                        foreach (CipherEnum cipher in aCPipe.InPipe)
        ...
        protected internal virtual async Task menuMainOneTwoThreeFish_Click(object sender, EventArgs e)
        {
            ...
            {
                Area23Log.LogOriginEx("EncryptFormAsymmetric.menuMainOneTwoThreeFish_Click", exShow, 1);
                Program.form123Fish = new OneTwoThreeFish();
            ...
            {
                Area23Log.LogOriginEx("EncryptFormAsymmetric.menuMainOneTwoThreeFish_Click", exHide, 1);
            }             
            this.Hide();
        ...
        protected internal virtual void menuMainComplex_Click(object sender, EventArgs e)
        {
            ...
            {
                Area23Log.LogOriginEx("EncryptFormAsymmetric.menuMainComplex_Click", exShow, 1);
                Program.formComplex = new EncryptFormMultiControls();
                Program.formComplex.Show();
            }
            try
            ...
            {
                Area23Log.LogOriginEx("EncryptFormAsymmetric.menuMainComplex_Click", exHide, 1);
            }
        ...
        protected internal virtual void menuMainSimple_Click(object sender, EventArgs e)
        {
            ...
            {
                Area23Log.LogOriginEx("EncryptFormAsymmetric.menuMainSimple_Click", exShow, 1);
                Program.formSimple = new EncryptFormSimple();
                Program.formSimple.Show();
            }
            try
            ...
            {
                Area23Log.LogOriginEx("EncryptFormAsymmetric.menuMainSimple_Click", exHide, 1);
            }
