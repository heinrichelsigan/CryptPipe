...
namespace EU.CqrXs.Gui.Forms
{
    public class EncryptFormBase : System.Windows.Forms.Form, IPlayable
    {
        ...
        protected internal virtual string[] GetCipherEnums(bool sorted = true)
        {
            ...
            foreach (object item in Enum.GetValues(typeof(EU.CqrXs.Crypt.Cipher.CipherEnum)))
        ...
        public SecureCipherPipe? GetSPipeFromFileName(string fileName)
        {
            ...
            string origName = fileName.StripSecureCipherPipeFromFileName(out SecureCipherPipe? fPipe);
            if (fPipe != null && 
